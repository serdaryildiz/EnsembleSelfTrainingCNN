...
using completely different train dataset
not all unlabeled data
"""
import argparse
import logging
import numpy
...
from exp9Utils import getDataLoaders, getPseudoLabels, getTrainDataForBaseLearners, getPretrain
...
def main(args):
    ...
    for i in range(args.num_base_learner):
        ...
        trainLoader = getTrainDataForBaseLearners(pseudoLabels, i, args, expPath, log)
...
def parse_opt():
    ...
    # parser.add_argument('--epoch-BL', type=int, default=40, help='learning rate')
